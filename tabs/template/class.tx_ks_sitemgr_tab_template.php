...
class tx_ks_sitemgr_tab_template extends tx_ks_sitemgr_tab{
	...
	function getStructures($id) {
		...
		foreach($TVtemplateObjects as $TVtemplateObject) {
			...
			#$TVtemplateObject['previewicon'] ='<img src="../uploads/tx_templavoila/'.$TVtemplateObject['previewicon'].'">';
			/*if(is_file(PATH_site.'uploads/tx_templavoila/'.$TVtemplateObject['previewicon'])) {
				$TVtemplateObject['previewicon'] = t3lib_BEfunc::getThumbNail('thumbs.php','../uploads/tx_templavoila/'.$TVtemplateObject['previewicon'],'',200);
			} else {
				$TVtemplateObject['previewicon'] = 'N/A';
			}*/
			$TVtemplateObject['datastructure']   = 'DS:'.$TVdataStructuresTitles[$TVtemplateObject['datastructure']];
